...
# print 'Wave numbers:',ss
        ...
        for Pcount in range(PP):
            ...
            EEo = data[Pcount * self._NShift:Pcount *
                       self._NShift + self._NTSub](order='tx...')
...
# __call__=get
    ...
    def background(self, S, A, wavenumber_smoothing_windows=((1000, 10,),),
                   frequencies_smoothing_windows=((.1, 5), (.2, 10), (.3, 20), (1000, 40))):
        """ return the background power
        Input:
        Power, with frequencies as dimension 0 and wave numbers as dim 1
        frenquencies_smoothing_windows: list of tuples of increasing frequency/number of 121 smoothing
...
def mask_data(power,
              wn_fq_couples=[[[13, 14], [0.09375, 0.10416667, 0.114583333333, 0.125, 0.21875, 0.22916667, ]],
                             [[-14.00, -13.00, -12.00, -11.00, -10.00, -9.00, -
                               8.00, ], [0.791666666667, 0.78125, 0.77083333]],
                             ]
              ):
